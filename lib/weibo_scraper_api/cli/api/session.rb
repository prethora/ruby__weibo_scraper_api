    ...
    module API
        class Session
            def login
                ...
                logger.info("WSAPI::API::Session#login")

                begin
                    puts Rainbow("Requesting QRCODE from weibo.com...").white.bright
                    puts ""
                    ...
                    @config.get_log_data.create_log e,"WSAPI::API::Session.login",strio.string
                    raise        
                end
            end
        end
